...
public class RunnerBuilderTest {
  ...
  private static final String EXP_CLASS_WITH_IDENTITY_NAMERS = ""
      ...
      + String.format("import java.lang.Deprecated;\n")
      ...
      + String.format("   */\n")
      + String.format("  public CompletableFuture<ClientResponse> run(final Client client)\n")
      ...
      + String.format("  public CompletableFuture<ClientResponse> runWithTimeout(final Client client, final Duration timeout)\n")
      + String.format("      throws NoConnectionsException, IOException {\n")
      + String.format("    CompletableFuture<ClientResponse> result = new CompletableFuture<ClientResponse>();\n")
      + String.format("    ProcedureCallback handler = VptUtil.getHandler(result);\n")

...
public class RunParameterClassTest {
  ...
  public void isPrimitiveReturnsFalse() {
    RunParameterClass testee = RunParameterClass.of(PARAMETER_PACKAGE, PARAMETER_TYPE, PARAMETER_NAME);
  ...
  public void equalsMethodWorks() {
    RunParameterClass a = RunParameterClass.of(PARAMETER_PACKAGE, PARAMETER_TYPE, PARAMETER_NAME);
    RunParameterClass b = RunParameterClass.of(PARAMETER_PACKAGE, PARAMETER_TYPE, PARAMETER_NAME);
    RunParameterClass c = RunParameterClass.of(PARAMETER_PACKAGE, PARAMETER_TYPE, "someOtherName");

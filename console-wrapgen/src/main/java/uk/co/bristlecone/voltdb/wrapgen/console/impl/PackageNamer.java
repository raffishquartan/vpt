...
public class PackageNamer {
  ...
  public PackageNamer(String packageBase, Pattern regexSuffix) {
   ...
   */
  public String getPackage(String procPackage) {
    Matcher suffixMatcher = regexSuffix.matcher(procPackage);
